"""Advisory messages for routesmit."""

from __future__ import annotations

from routesmit.types import HostCapabilities, RoutePlan


PINNED_MODEL_ADVISORY = (
    "Pinned model execution is active. Auto mode is recommended for mixed tasks "
    "because routesmit can decompose planning, coding, testing, and documentation "
...
NO_SWITCH_ADVISORY = (
    ...
    "routesmit will optimize prompts and decompose tasks, but cannot change models."
)
