...
# routesmit - VS Code / Copilot Instructions

This workspace uses routesmit for host-aware task routing.

## How it works

- routesmit decomposes mixed prompts into focused subtasks.
...
- routesmit provides structured prompts and task decomposition instead.

## Usage

For any mixed-task prompt, routesmit will:
...
class VSCodeInstaller(BaseInstaller):
    """Install routesmit configuration for VS Code."""
