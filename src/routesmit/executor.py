"""Executor - orchestrates the full routesmit pipeline."""

from __future__ import annotations

import time

from routesmit.advisory import generate_advisory
from routesmit.config import load_config
from routesmit.hosts.detector import detect_host, get_host_adapter
from routesmit.metrics import RouteMetrics, compute_metrics
from routesmit.planner import Planner
from routesmit.review import review_plan, review_results
from routesmit.router import Router
from routesmit.state import save_route
...
class Executor:
    """Main orchestration engine for routesmit."""
