...
from routesmit.types import RoutePlan, TaskResult
...
def save_route(
    ...
    metrics: Any,
    routes_dir: str = ".routesmit/routes",
) -> Path:
...
def list_routes(routes_dir: str = ".routesmit/routes") -> list[dict[str, Any]]:
...
def get_last_route(routes_dir: str = ".routesmit/routes") -> dict[str, Any] | None:
