"""Structured observability for routesmit - JSON logging and timing."""
...
def get_logger(name: str = "routesmit", structured: bool = False) -> logging.Logger:
    """Get a routesmit logger with optional structured output."""
